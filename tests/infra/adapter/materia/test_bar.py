...
def test_adapt_to_tbl_bar_alpaca():
    bar = generate_bar()
    # min
    tbl_bar_alpaca_min = adapt_to_tbl_bar_alpaca(bar, Timeframe.MIN)
    assert isinstance(tbl_bar_alpaca_min, TblBarMinAlpaca)
    # hour
    tbl_bar_alpaca_hour = adapt_to_tbl_bar_alpaca(bar, Timeframe.HOUR)
