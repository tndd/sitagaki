...
from infra.process.api.alpaca.historical import (
    convert_bar_alpaca_list_api_to_table,
    extract_bar_alpaca_list_api_from_barset,
)
...
def test_convert_bar_alpaca_list_api_to_table():
    bar_alpaca_list = generate_bar_alpaca_list()
    tbl_bars_alpaca = convert_bar_alpaca_list_api_to_table(bar_alpaca_list, Timeframe.DAY)
